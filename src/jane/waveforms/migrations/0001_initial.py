    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, editable=False, related_name='mappings_created')),
                ('modified_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, editable=False, related_name='mappings_modified')),
            ],
            options={
                'ordering': ['-timerange'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, editable=False, related_name='restrictions_created')),
                ('modified_by', models.ForeignKey(null=True, to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE, editable=False, related_name='restrictions_modified')),
        ...
        migrations.AddField(
            model_name='file',
            name='path',
            field=models.ForeignKey(related_name='files', to='waveforms.Path', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='continuoustrace',
            name='file',
            field=models.ForeignKey(related_name='traces', to='waveforms.File', on_delete=models.CASCADE),
        ),
